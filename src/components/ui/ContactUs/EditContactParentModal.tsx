...
interface EditContactParentModalProps {
  open: boolean;
  onCancel: () => void;
...
const EditContactParentModal: React.FC<EditContactParentModalProps> = ({
  open,
  onCancel,
  onSubmit,
  initialValues,
    ...
    >
      <Form form={form} layout="vertical" onFinish={onSubmit} requiredMark={false}>
        ...
        <div className="space-y-6">
          <Form.Item name="address" label={<span className={labelStyle}>Address</span>} className="mb-0">
          ...
          <Form.Item name="websiteLink" label={<span className={labelStyle}>Website Link</span>} className="mb-0">
            <Input placeholder="Enter website link" className={inputStyle} />
          </Form.Item>

          <Form.Item name="openHours" label={<span className={labelStyle}>Open Hours</span>} className="mb-0">
...
export default EditContactParentModal;
